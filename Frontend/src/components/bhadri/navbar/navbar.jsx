...
export function Navbar(){
    return(
        <div style={{ backgroundColor: "#D9D9D9", display: "flex", flexDirection: "column", position: "sticky", top: "0px"}}>
            ...
            <div style={{display: "flex", justifyContent: "center"}}>
                ...
                <div style={{display: "flex", flexDirection: "row", backgroundColor: "white", padding: "10px", paddingRight: "150px", paddingLeft: "150px", gap: "80px", fontFamily: "poppins"}}>
                    ...
                    <select style={{border: "none", backgroundColor: "white", width: "160px", fontSize: "20px", outline: "none", fontWeight: "bold"}}>
